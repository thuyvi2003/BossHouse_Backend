  ...
  try {
    ...
    const services = await Service.insertMany([
      ...
      },
      {
        ...
        description: "Consultation for adopting a pet",
        base_price: 20,
        duration_minutes: 60,
      },
    ]);
    ...
    // Create bookings with services as array
    await Booking.insertMany([
      ...
      },
      {
        ...
        services: [
          ...
          {
            service_id: services.find((s) => s.name === "Boarding")._id,
            quantity: 1,
          }, // ví dụ nhiều dịch vụ
        ],
        veterinarian_id: vets[1]._id,
